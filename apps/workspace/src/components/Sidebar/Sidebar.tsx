      ...
      <div className="relative flex flex-1 flex-col min-h-0">
        ...
        <div className="flex-1 overflow-y-auto py-6 px-3">
          <nav className="space-y-1">
            <p className="px-4 pb-1 pt-1 text-xs font-semibold uppercase tracking-wider text-gray-500">Overview</p>            
            <Link href="/" className={`flex items-center gap-3 rounded-lg px-4 py-2 text-left text-[14px] font-medium transition-all ${activeMenu === "dashboard" ? "bg-indigo-50 text-indigo-600 shadow-sm" : "text-gray-700 hover:text-indigo-600 hover:bg-indigo-50"}`} onClick={handleNavClick}>
            ...
            <p className="px-4 pb-1 pt-4 text-xs font-semibold uppercase tracking-wider text-gray-500">Appointments</p>
            <Link href="/bookings" className={`flex items-center gap-3 rounded-lg px-4 py-2 text-left text-[14px] font-medium transition-all ${ activeMenu === "bookings" ? "bg-indigo-50 text-indigo-600 shadow-sm" : "text-gray-700 hover:text-indigo-600 hover:bg-indigo-50" }`} onClick={handleNavClick}>
              ...
              Bookings
              {newBookingsCount > 0 && (
                <span className="ml-auto inline-flex items-center justify-center w-5 h-5 rounded-full shrink-0 bg-indigo-600 text-xs font-semibold text-white">
                  {newBookingsCount}
                </span>
              )}
            </Link>
            <Link href="/calendar" className={`flex items-center gap-3 rounded-lg px-4 py-2 text-left text-[14px] font-medium transition-all ${ activeMenu === "calendar" ? "bg-indigo-50 text-indigo-600 shadow-sm" : "text-gray-700 hover:text-indigo-600 hover:bg-indigo-50" }`} onClick={handleNavClick}>
            ...
            <Link href="/availability" className={`flex items-center gap-3 rounded-lg px-4 py-2 text-left text-[14px] font-medium transition-all ${ activeMenu === "availability" ? "bg-indigo-50 text-indigo-600 shadow-sm" : "text-gray-700 hover:text-indigo-600 hover:bg-indigo-50" }`} onClick={handleNavClick}>
            ...
            <p className="px-4 pb-1 pt-4 text-xs font-semibold uppercase tracking-wider text-gray-500">Setup</p>
            <Link href="/event-type" prefetch={false} className={`flex items-center gap-3 rounded-lg px-4 py-2 text-left text-[14px] font-medium transition-all ${ activeMenu === "event-type" ? "bg-indigo-50 text-indigo-600 shadow-sm" : "text-gray-700 hover:text-indigo-600 hover:bg-indigo-50" }`} onClick={handleNavClick}>
            ...
            <Link href="/intakeform" className={`flex items-center gap-3 rounded-lg px-4 py-2 text-left text-[14px] font-medium transition-all ${ activeMenu === "intakeform" ? "bg-indigo-50 text-indigo-600 shadow-sm" : "text-gray-700 hover:text-indigo-600 hover:bg-indigo-50" }`} onClick={handleNavClick}>
            ...
            <Link href="/departments" className={`flex items-center gap-3 rounded-lg px-4 py-2 text-left text-[14px] font-medium transition-all ${ activeMenu === "departments" ? "bg-indigo-50 text-indigo-600 shadow-sm" : "text-gray-700 hover:text-indigo-600 hover:bg-indigo-50" }`} onClick={() => { setIsDepartmentsSubmenuOpen(true); handleNavClick(); }}>
            ...
            <Link href="/services" className={`flex items-center gap-3 rounded-lg px-4 py-2 text-left text-[14px] font-medium transition-all ${ activeMenu === "services" ? "bg-indigo-50 text-indigo-600 shadow-sm" : "text-gray-600 hover:text-indigo-600 hover:bg-indigo-50" }`} onClick={handleNavClick}>
            ...
            <button
              ...
              className="flex w-full items-center justify-between px-4 pb-1 pt-4 text-xs font-semibold uppercase tracking-wider text-gray-500 transition-colors hover:text-gray-700"
            >
            ...
            {isAdminCenterOpen && (
            <>
            <Link href="/team-members" className={`flex items-center gap-3 rounded-lg px-4 py-2 text-left text-[14px] font-medium transition-all ${ activeMenu === "team-members" ? "bg-indigo-50 text-indigo-600 shadow-sm" : "text-gray-700 hover:text-indigo-600 hover:bg-indigo-50" }`} onClick={handleNavClick}>
            ...
            <Link href="/integrations" className={`flex items-center gap-3 rounded-lg px-4 py-2 text-left text-[14px] font-medium transition-all ${ activeMenu === "integrations" ? "bg-indigo-50 text-indigo-600 shadow-sm" : "text-gray-700 hover:text-indigo-600 hover:bg-indigo-50" }`} onClick={handleNavClick}>
            ...
            <Link href="/roles-permissions" className={`flex items-center gap-3 rounded-lg px-4 py-2 text-left text-[14px] font-medium transition-all ${ activeMenu === "roles-permissions" ? "bg-indigo-50 text-indigo-600 shadow-sm" : "text-gray-700 hover:text-indigo-600 hover:bg-indigo-50" }`} onClick={handleNavClick}>
            ...
            {/* <Link href="/billings" className={`flex items-center gap-3 rounded-lg px-4 py-2 text-left text-[14px] font-medium transition-all ${ activeMenu === "billings" ? "bg-indigo-50 text-indigo-600 shadow-sm" : "text-gray-700 hover:text-indigo-600 hover:bg-indigo-50" }`} onClick={handleNavClick}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-4.5 w-4.5" aria-hidden="true"><rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/></svg>
              Billing &amp; Plans
            </Link>             */}
            <Link href="/contacts" className={`flex items-center gap-3 rounded-lg px-4 py-2 text-left text-[14px] font-medium transition-all ${ activeMenu === "contacts" ? "bg-indigo-50 text-indigo-600 shadow-sm" : "text-gray-700 hover:text-indigo-600 hover:bg-indigo-50" }`} onClick={handleNavClick}>
            ...
            <Link href="/settings" className={`flex items-center gap-3 rounded-lg px-4 py-2 text-left text-[14px] font-medium transition-all ${ activeMenu === "settings" ? "bg-indigo-50 text-indigo-600 shadow-sm" : "text-gray-700 hover:text-indigo-600 hover:bg-indigo-50" }`} onClick={handleNavClick}>
