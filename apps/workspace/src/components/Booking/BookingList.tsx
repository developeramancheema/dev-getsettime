  ...
  return (
    <div className="min-h-screen">
      <section className="mx-auto space-y-5">
        ...
        {/* Filters card */}
        <div className="rounded-2xl border border-slate-200/70 bg-white/90 p-4 shadow-[0_16px_40px_-20px_rgba(15,23,42,0.18)] backdrop-blur">
          <BookingFilters
            filter={filter}
        ...
        <ScreenGate minWidth={1024}>
        {/* Desktop table */}
        <div className="overflow-hidden rounded-2xl border border-slate-200/70 bg-white/90 shadow-xl">
        ...
        <div className="space-y-2">
          ...
          {!loading && displayBookings.length > 0 && (
            <div className="flex items-center justify-between rounded-xl border border-slate-200/70 bg-white/90 px-4 py-3 shadow-sm">
