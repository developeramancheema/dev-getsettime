...
type CalendarMobileWeekBookingsProps = {
  selectedDate: Date;
  bookings: Booking[];
  loading: boolean;
...
export function CalendarMobileWeekBookings({
  selectedDate,
  bookings,
  loading,
  onSelectBooking,
  selectedBookingId,
  onGoToToday,
}: CalendarMobileWeekBookingsProps) {
      ...
      {loading ? (
        ...
        <div className="relative">
          {hourSlots.map((hour) => {
            ...
            return (
              <div key={hour} className="grid grid-cols-[3.25rem_minmax(0,1fr)] border-b border-slate-100 last:border-b-0">
                <div className="text-center h-full flex flex-col border-r border-slate-100 p-3 leading-tight">
