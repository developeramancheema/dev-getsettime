    ...
    <div className="text-slate-900">
      <div className="mx-auto space-y-6">
        ...
        <div className="rounded-3xl border border-slate-200 bg-white shadow-sm">
          <div className="flex gap-2 border-b border-slate-100 px-4 py-4 flex-row items-center justify-between">
            <div>
            ...
            <div className="inline-flex w-fit items-center gap-2 rounded-lg bg-indigo-50 px-2 py-1 text-xs font-bold uppercase tracking-wide text-indigo-700">
              <span
          ...
          {loading ? (
            ...
            <>
              ...
              {/* Mobile view */}
              <div className="block space-y-3 px-4 py-4">
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex min-w-0 items-start gap-3">
                          ...
                          <div className="flex flex-col gap-1 min-w-0">
                            ...
                            <span className="min-w-0 truncate text-xs md:text-sm text-slate-400">
                              {contact.email || "—"}
                            </span>

                            <div className="w-fit inline-flex rounded-lg bg-slate-100 px-2.5 py-1 text-xs font-bold text-slate-500">
                              Customer / Lead
                            </div>
                  ...
                  <tbody className="divide-y divide-slate-100">
                    {filtered_contacts.map((contact) => (
                      ...
                      >
                        ...
                        <td className="text-sm px-4 py-3.5 border-b border-slate-100" data-label="Email">
                          {contact.email || "—"}
                        </td>

                        <td className="text-sm px-4 py-3.5 border-b border-slate-100" data-label="Phone">
                          {contact.phone || "—"}
                        </td>

                        <td className="text-sm px-4 py-3.5 border-b border-slate-100" data-label="Location">
                        ...
                        <td className="text-sm px-4 py-3.5 border-b border-slate-100" data-label="Last Booking">
                          {get_last_booking_label(contact)}
                        </td>
                        ...
                        <td className="text-sm px-4 py-3.5 border-b border-slate-100" data-label="Actions">
                          <div className="flex items-center justify-end gap-2">
                            <IconButton
                              ...
                              icon={<Icon name="eye" className="h-4 w-4" />}
                              title=""
                              colorClass="border border-slate-200 bg-white text-slate-600 transition hover:border-indigo-200 hover:bg-indigo-50 hover:text-indigo-700 py-3"
                            />
